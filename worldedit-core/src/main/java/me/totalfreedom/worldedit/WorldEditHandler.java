...
public class WorldEditHandler {
    ...
    public static void selectionChanged(com.sk89q.worldedit.entity.Player wePlayer) {
        ...
        final SelectionChangedEvent event = new SelectionChangedEvent(
                player,
                player.getWorld(),
                new Vector(region.getMinimumPoint().x(), region.getMinimumPoint().y(), region.getMinimumPoint().z()),
                new Vector(region.getMaximumPoint().x(), region.getMaximumPoint().y(), region.getMaximumPoint().z()));
